...
class GeminiAudioUtils:
    ...
    async def _convert_to_wav(self, 
    ...
    async def analyze_audio_content(self,
                                  audio_input: Union[str, bytes, BinaryIO],
        ...
        try:
            ...
            default_prompt = "Analyze the following audio transcript and provide insights:"
    ...
    async def summarize_audio(self,
                            audio_input: Union[str, bytes, BinaryIO],
